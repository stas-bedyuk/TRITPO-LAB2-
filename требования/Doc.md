...
// Можно добавить информационное поле, которое будет информировать пользователя о текущих курсах валют
// для пользователей не из РБ было бы неплохо добавить другие валюты (например фунты, гривны, злотые, юани)
// Было бы неплохо добавить выбор страны, для того чтобы получаемая информация была максимально корректной (курсы разные в разных странах)
...
// Помимо этого можно создать веб-страницу с таким же функционалом
...
// Для пользователей из других стран неактуально
...
// Предлагаю помимо этого выводить актуальные курсы валют на экран
...
// А также необходимо проверить правильность данных, считываемых с сайта нацбанка
